...
Tab* initHydTab()
{
	Tab* HydTab = new Tab(MainViews::Game, Point(0,0), HybridTab_Sprite, &BGHybrid, Controllers::hydTabController);
	
	View* HydTopLeftPoint = new View(NULL, kBottomScreen, Point(0,32));
	
		// checkboxes (Hybrid Type)
		CheckBox* HasHybrid = new CheckBox(HydTopLeftPoint, Point(88, 8), HasHybrid_Sprite);
		
			HydTab->add(HasHybrid);
				Controllers::hydTabController->set_HasHybrid(HasHybrid);
		
		CheckBox* UsesKINECT = new CheckBox(HydTopLeftPoint, Point(224, 8), UsesKINECT_Sprite);
		...
		SpecialBox* LowerBridge = new SpecialBox(HydTopLeftPoint, Point(32, 32), LwrBrdg_Sprite);
		SpecialBox* HybridAssist = new SpecialBox(HydTopLeftPoint, Point(96, 32), HybAssist_Sprite);
		SpecialBox* Other = new SpecialBox(HydTopLeftPoint, Point(160, 32), Other_Sprite);
		...
		NumberSprite* TopScore = new NumberSprite(HydTopLeftPoint, Point(144, 82), Top_Sprite);
		NumberSprite* MidScore = new NumberSprite(HydTopLeftPoint, Point(144, 104), Mid_Sprite);
		NumberSprite* LowScore = new NumberSprite(HydTopLeftPoint, Point(144, 126), Low_Sprite);
