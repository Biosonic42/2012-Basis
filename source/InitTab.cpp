...
Tab* initInitTab()
{
	Tab* InitTab = new Tab(MainViews::Info, Point(0,160), BlankTab_Sprite, &BGBlank, Controllers::initTabController);
	
		SpecialBox* AllianceColor1 = new SpecialBox(InitTab, Point(0,0), RedBlue_Sprite);
		SpecialBox* AllianceColor2 = new SpecialBox(InitTab, Point(64,0), RedBlue_Sprite);
		SpecialBox* AllianceColor3 = new SpecialBox(InitTab, Point(128,0), RedBlue_Sprite);
		SpecialBox* AllianceColor4 = new SpecialBox(InitTab, Point(192,0), RedBlue_Sprite);
		...
		NumberSprite* TeamNum = new NumberSprite(InitTab, Point(52,8), BlankTitle_Sprite);
		
			InitTab->add(TeamNum);
				Controllers::initTabController->set_TeamNum(TeamNum);
		
		NumberSprite* MatchNum = new NumberSprite(InitTab, Point(140,8), BlankTitle_Sprite);
		
			InitTab->add(MatchNum);
				Controllers::initTabController->set_MatchNum(MatchNum);
		
		NumberSprite* DSNum = new NumberSprite(InitTab, Point(244,8), BlankTitle_Sprite);
